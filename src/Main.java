...
public class Main {
	...
	public static void main(String[] args) throws IOException{
		...
		Map<Object, ArrayList<CalendarEvent>> map = Filter.filterByDates(list, new DateTime(2011, 12, 12, 0, 0), new DateTime(2011, 12, 13, 23, 0));
		...
		PrintWriter pw = new PrintWriter(new FileWriter("/Users/lenajia/Documents/Sophomore 2011/Spring Semester/Compsci 108/Programs/Tivoo/output.html"));
